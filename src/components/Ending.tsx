    ...
    <section id="ending" style={{
      ...
      <div style={{ position: 'relative', zIndex: 2 }}>
        ...
        <p className="reveal" style={{
          ...
          {opened
            ? 'Tương lai chính thức mở ra rồi nè. Mình đi thay đổi thế giới thôi (hoặc ngủ một giấc đã) 🌷'
            : 'Chương tiếp theo vẫn còn để trống — và đó mới là phần thú vị.'}
        </p>

        <button onClick={() => setOpened(o => !o)} className="btn btn-primary reveal" style={{ fontSize: 19, padding: '20px 38px' }}>
