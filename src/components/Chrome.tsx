...
function Pill({ icon, label, onClick, accent, title }: PillProps) {
  return (
...
export default function Chrome({ visitorName, onClearName }: ChromeProps) {
