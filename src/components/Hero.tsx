...
export default function Hero({ visitorName }: HeroProps) {
  return (
    <section className="section" id="hero" style={{
      paddingTop: 130, paddingBottom: 80, position: 'relative',
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <h1 style={{
          ...
          Bi Tốt Nghiệp
          <img src="/assets/stickers/sparkle.svg" alt="" className="float-a" style={{ position: 'absolute', top: -18, right: -52, width: 64, height: 64 }}/>
          <img src="/assets/stickers/heart.svg" alt="" className="float-b" style={{ position: 'absolute', bottom: -8, left: -56, width: 52, height: 52 }}/>
        </h1>
        ...
        <div style={{
          ...
          <img src="/assets/stickers/cap.svg" alt="" style={{ width: 32, height: 28 }}/>
