// Loading.jsx — cute loading screen with bobbling mascot
const { useEffect: useEffectLoading, useState: useStateLoading } = React;

function Loading({ onDone }) {
  const [out, setOut] = useStateLoading(false);
  useEffectLoading(() => {
  ...
  return (
    <div style={{
      ...
      <img src={window.__resources.mascot} width="140" height="140" alt=""
